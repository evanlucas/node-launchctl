...
var LaunchCTLError = require('./launchctl_error').createError();
exports.error = LaunchCTLError.getError;
/*!
 * Expose LaunchCTL
 */
 ...
 *
 * @param {String} The path to the job's configuration plist
 * // TODO: Add options for -w flag, session_type, and domain
 *
 * @api public
 */
exports.unloadSync = function(path) {
  return ctl.unloadJobSync(path);
}